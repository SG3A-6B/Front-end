...
export default function Cart({ url, cart, removeFromCart, updateAmount, empty }) {
    ...
    if (finished === false) {
                    ...
                    <>
                        ...
                        <form onSubmit={order}>
                            ...
                            <div className="buttons">
                                <button className="btn btn-primary tilausbtn">Tilaa</button>
                            </div>
                        </form>
                    </>
                }
        ...
        return (<h3 className="completed">Kiitos tilauksestasi!</h3>)
    }
}
